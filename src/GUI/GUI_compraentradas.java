...
public class GUI_compraentradas extends javax.swing.JDialog {
    ...
    private JLabel compratitulo;
    private JLabel comprafecha;
    ...
    public GUI_compraentradas(String titulo, String fecha, String hora, String numsala) {
        ...
        compratitulo = new JLabel("COMPRA DE ENTRADAS EN DESARROLLO\n"+titulo);
        comprafecha = new JLabel(" el día" + fecha);
        comprahora = new JLabel(" a las: " + hora);
        comprasala = new JLabel("en la sala " + numsala);
